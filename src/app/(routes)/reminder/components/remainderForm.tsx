    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        try {
            const resp = await axios.post(
                `${env.NEXT_PUBLIC_APP_URL}/api/reminder`,
                {
                    ...values
                }
            )
                        ...
                        <FormItem className="grid  gap-1">
                            ...
                            <SingleSelect onValueChange={field.onChange} defaultValue={"PENDING"}>
                                ...
                                <SelectContent>
                                    ...
                                    <SelectItem disabled value="INPROGRESS">INPROGRESS</SelectItem>
                                    <SelectItem disabled value="COMPLETED">COMPLETED</SelectItem>
                                    <SelectItem disabled value="EXPIRED">EXPIRED</SelectItem>
                                </SelectContent>
                            </SingleSelect>
                            <FormMessage />
                        </FormItem>
