...
import RemainderEditForm from "../../components/reminderEditForm";
...
const ReminderEditpage = async ({ params }: {
    params: {
        reminderId: string
    }
}) => {
    ...
    return <>
        <div className="w-full flex-1 space-y-4 overflow-x-auto px-6 pt-4">
            <div className="h-full flex-col">
                ...
                <div className="">
                    <RemainderEditForm data={{ ...data, description: data.description as string, duedate: data.duedate.toISOString() }} />
